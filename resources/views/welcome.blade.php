        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <div class="ml-4 text-lg text-white leading-7 font-semibold dark:text-white">Laravel Product Manager</div>
                </div>                
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div>
                            @auth
                                <div class="p-6"><a href="{{ url('/dashboard') }}" class="p-6 ml-4 text-lg leading-7 font-semibold dark:text-white">Dashboard</a></div>
                            @else
                                <div class="p-6">
